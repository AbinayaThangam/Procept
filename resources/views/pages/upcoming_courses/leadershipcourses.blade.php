...
<section id="courses-level-container">
    <div class="courses-level">
        ...
        <div class="beginner-course-container">
            ...
            @if ($getLeadershipCourses->firstWhere('name', config('app_constants.BEGINNER')))
            <div class="beginner-course mt-5">
                ...
                @php
                $beginnerCourse = $getLeadershipCourses->firstWhere('name', config('app_constants.BEGINNER'));
                @endphp
            ...
            <div class="row course-level">
                <div class="col-3 course-id">
                    ...
                    @foreach ($getLeadershipCourses as $course)
    ...
    @if ($getLeadershipCourses->firstWhere('name', config('app_constants.INTERMEDIATE')))
    <div class="intermediate-course-container">
        <div class="intermediate-course mt-5">
            ...
            @php
            $intermediateCourse = $getLeadershipCourses->firstWhere('name', config('app_constants.INTERMEDIATE'));
            @endphp
...
@endif
@if ($getLeadershipCourses->firstWhere('name', config('app_constants.ADVANCED')))
    <div class="advanced-course-container">
        <div class="advanced-course mt-5">
            ...
            @php
            $advancedCourse = $getLeadershipCourses->firstWhere('name', config('app_constants.ADVANCED'));
            @endphp
